...
def setup_logging(logfilestandardname: 'str: Words to prepend the log files for easy identification' = 'log',
                  ...
                  stdoutlogginglevel: 'A valid Python logging level eg. logging.INFO, logging.ERROR etc.' = logging.INFO,
    ...
    logging.basicConfig(level=stdoutlogginglevel)
